...
namespace Maternity
{
    public class MaternityPatientDetailCardPatientInBedState : MaternityPatientDetailCardBaseState
    {

        private MaternityWaitingRoomBed bed;
        private IMaternityFacilityPatient patient;

        public MaternityPatientDetailCardPatientInBedState(MaternityWaitingRoomBed bed, IMaternityFacilityPatient patient, MaternityPatientDetailCard card) : base(card)
        {
            this.bed = bed;
