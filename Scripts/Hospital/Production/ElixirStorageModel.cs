...
namespace Hospital
{
    public class ElixirStorageModel : ElixirStorage
    {

        private const string OBJECT_TAG = "EliStore";
        ...
        protected override void Init()
        {
            ...
            {
                Game.Instance.gameState().ElixirStore = this;
            }
        }
        ...
        protected override void LoadFromString(string save, TimePassedObject timePassed, int ActionsDone = 0)
        {
            ...
            //Debug.LogError("Sprawdzić to -> case upgrade'u storage'a");
            /*
        ...
        public static bool IsElixirStorage(string model)
        {
