...
public class SpecialLayoutModule : IAPBaseLayoutModule
{
...
#pragma warning restore 0649
    ...
    public override void InitializeModule(IAPShopData shopData)
    {
        ...
        foreach (KeyValuePair<IAPShopBundleID, BundleOfferCard> pair in shopData.SpecialOfferCards)
        {
            if(pair.Value.IsCreative())
            {
                ...
                cardUI.model = shopData.SpecialOfferCards[pair.Key];
                cardUI.Initialize();
                cardUI.RefreshData();
    ...
    {
        return ReferenceHolder.Get().IAPShopController.IsSpecialOffersExist();
    }
