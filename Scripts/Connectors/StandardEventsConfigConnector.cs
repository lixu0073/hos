...
{
    //public static class StandardEventsConfigConnector
    //{
    ...
    //    public static Task<StandardEventsConfigModel> LoadAsync(string key)
    //    {
    //        return Context.LoadAsync<StandardEventsConfigModel>(key);
    //    }
    //}
}