...
{
    public static class AnalyticsConnector
    {
        ...
        public static Task SaveAsync(AnalyticsModel analytics)
        {
            return Context.SaveAsync<AnalyticsModel>(analytics);
        }

        public static Task<AnalyticsModel> LoadAsync(string key)
        {
            return Context.LoadAsync<AnalyticsModel>(key);
        }
    }
}